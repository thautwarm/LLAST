...
; <label>:11:                                     ; preds = %6, %0
  %12 = getelementptr inbounds %struct.S, %struct.S* %2, i32 0, i32 0
  %13 = load i32, i32* %12, align 4
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"\01??_C@_02DPKJAMEF@?$CFd?$AA@", i32 0, i32 0), i32 %13)
